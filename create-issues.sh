...
# PriCal Issues Only Script
# Run this after enabling Issues on your repo
...
echo "🚀 Creating issues for PriCal 2026 Roadmap..."
echo ""
...
echo -e "${GREEN}Creating Sprint 1 issues...${NC}"
...
# ============================================================================
# SPRINT 2: CSV Import Feature
# ============================================================================

echo -e "${GREEN}Creating Sprint 2 issues...${NC}"
...
# ============================================================================
# SPRINT 3: Legal & Branding
# ============================================================================

echo -e "${GREEN}Creating Sprint 3 issues...${NC}"
...
## Time Estimate
2 hours" --label "marketing" --milestone "Sprint 3: Legal & Branding"
...
# ============================================================================
# SPRINT 4: Onboarding & Email
# ============================================================================

echo -e "${GREEN}Creating Sprint 4 issues...${NC}"
...
echo -e "${GREEN}Creating Sprint 5 issues...${NC}"
...
# ============================================================================
# SPRINT 6: Domain Allowlisting
# ============================================================================

echo -e "${GREEN}Creating Sprint 6 issues...${NC}"
...
# ============================================================================
# SPRINT 7: Activity Log Enhancements
# ============================================================================

echo -e "${GREEN}Creating Sprint 7 issues...${NC}"
...
echo -e "${GREEN}Creating Sprint 8 issues...${NC}"
...
echo -e "${GREEN}Creating Sprint 9 issues...${NC}"
...
# ============================================================================
# SPRINT 10: Beta Onboarding
# ============================================================================

echo -e "${GREEN}Creating Sprint 10 issues...${NC}"
...
# ============================================================================
# SPRINT 11: Beta Iteration
# ============================================================================

echo -e "${GREEN}Creating Sprint 11 issues...${NC}"
...
# ============================================================================
# SPRINT 12: Beta Wrap-up
# ============================================================================

echo -e "${GREEN}Creating Sprint 12 issues...${NC}"
...
# ============================================================================
# SPRINT 13: Content Foundation
# ============================================================================

echo -e "${GREEN}Creating Sprint 13 issues...${NC}"
...
# ============================================================================
# SPRINT 14: SEO Content Push
# ============================================================================

echo -e "${GREEN}Creating Sprint 14 issues...${NC}"
...
# ============================================================================
# SPRINT 15: Vertical Content & Social
# ============================================================================

echo -e "${GREEN}Creating Sprint 15 issues...${NC}"
...
# ============================================================================
# SPRINT 16: Product Hunt Prep
# ============================================================================

echo -e "${GREEN}Creating Sprint 16 issues...${NC}"
...
# ============================================================================
# SPRINT 17: Demo & Conversion
# ============================================================================

echo -e "${GREEN}Creating Sprint 17 issues...${NC}"
...
# ============================================================================
# SPRINT 18: Final Launch Prep
# ============================================================================

echo -e "${GREEN}Creating Sprint 18 issues...${NC}"
...
- [ ] Landing page under 3s load

## Time Estimate
1 hour" --label "launch" --milestone "Sprint 18: Final Launch Prep"

# ============================================================================
# SPRINT 19: Soft Public Launch
# ============================================================================

echo -e "${GREEN}Creating Sprint 19 issues...${NC}"
...
## Template
'Thanks for trying PriCal! I'm the founder. Let me know if you have any questions.'
...
# ============================================================================
# SPRINT 20: Product Hunt Launch
# ============================================================================

echo -e "${GREEN}Creating Sprint 20 issues...${NC}"
...
# ============================================================================
# SPRINT 21: Post-Launch Momentum
# ============================================================================

echo -e "${GREEN}Creating Sprint 21 issues...${NC}"
...
# ============================================================================
# SPRINT 22: Outbound & Partnerships
# ============================================================================

echo -e "${GREEN}Creating Sprint 22 issues...${NC}"
...
# ============================================================================
# SPRINT 23: Influencer Partnerships
# ============================================================================

echo -e "${GREEN}Creating Sprint 23 issues...${NC}"
...
# ============================================================================
# SPRINT 24: Promotion Push
# ============================================================================

echo -e "${GREEN}Creating Sprint 24 issues...${NC}"
...
# ============================================================================
# SPRINT 25: Year-End & 2027 Planning
# ============================================================================

echo -e "${GREEN}Creating Sprint 25 issues...${NC}"
...
echo ""
echo -e "${GREEN}✅ Done! Created all issues for 25 sprints.${NC}"
echo ""
echo "Visit https://github.com/$REPO/issues to see your issues"